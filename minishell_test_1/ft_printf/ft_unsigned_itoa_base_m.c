...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_unsigned_itoa_base_m.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gsotty <marvin@42.fr>                      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/02/21 15:39:28 by gsotty            #+#    #+#             */
/*   Updated: 2017/02/21 15:39:30 by gsotty           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char			*ft_unsigned_itoa_base_m(unsigned int value, int base)
{
	size_t			size;
	size_t			i;
	char			*tmp;
